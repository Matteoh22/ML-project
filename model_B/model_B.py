...
OUT_DIR  = Path("/Users/matteohasa/Desktop/ML-project/outputs/model_C_compact_scientific_fixed"); OUT_DIR.mkdir(parents=True, exist_ok=True)
...
hist1 = model.fit(ds_train, validation_data=ds_val, epochs=EPOCHS_P1, verbose=1,
                  callbacks=[
                      ...
                      tf.keras.callbacks.EarlyStopping(monitor="val_loss", mode="min", min_delta=0.003, patience=3, restore_best_weights=True, start_from_epoch=3, verbose=1),
                  ])
